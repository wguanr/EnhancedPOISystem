...
#include "GrPOIModeInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UGrPOIModeInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UGrPOIModeInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UGrPOIModeInteractiveTool* NewTool = NewObject<UGrPOIModeInteractiveTool>(SceneState.ToolManager);
...
UGrPOIModeInteractiveToolProperties::UGrPOIModeInteractiveToolProperties()
{
...
void UGrPOIModeInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UGrPOIModeInteractiveTool::Setup()
{
	...
	Properties = NewObject<UGrPOIModeInteractiveToolProperties>(this, "Measurement");
...
void UGrPOIModeInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UGrPOIModeInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UGrPOIModeInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UGrPOIModeInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UGrPOIModeInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UGrPOIModeInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UGrPOIModeInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UGrPOIModeInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UGrPOIModeInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
