...
#include "GrPOIModeInteractiveTool.generated.h"


/**
 * Builder for UGrPOIModeInteractiveTool
 */
UCLASS()
class GRPOIMODE_API UGrPOIModeInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UGrPOIModeInteractiveTool
 */
UCLASS(Transient)
class GRPOIMODE_API UGrPOIModeInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UGrPOIModeInteractiveToolProperties();
...
/**
 * UGrPOIModeInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class GRPOIMODE_API UGrPOIModeInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UGrPOIModeInteractiveToolProperties> Properties;
