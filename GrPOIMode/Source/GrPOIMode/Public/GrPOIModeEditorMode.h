...
#include "GrPOIModeEditorMode.generated.h"
 ...
 */
UCLASS()
class UGrPOIModeEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_GrPOIModeEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UGrPOIModeEditorMode();
	virtual ~UGrPOIModeEditorMode();
